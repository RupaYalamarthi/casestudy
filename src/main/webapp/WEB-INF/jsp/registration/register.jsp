...
<tr> <td>Last Name</td>
 ...
 <tr><td>Age</td>
<td><input type="text" name ="age" value="${formBeanKey.age}"></td></tr>

<tr><td>Password </td><td><input type="password" name ="password" value="${formBeanKey.password}"></td></tr>
<tr><td>Confirm Password</td><td> <input type="password" name ="confirmPassword" value="${formBeanKey.confirmPassword}"></td></tr>
